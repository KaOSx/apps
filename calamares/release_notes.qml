...
Item {
    ...
    Flickable {
        ...
        TextArea {
            ...
            A limited number of the most well-known GTK applications are available, examples Firefox 74.0.1, Chrome 84, Ardour 5.12.0, Inkscape 0.92.5, GIMP 2.10.18 and Google-talkplugin 5.41.3.0.1.<br />
