...
Item {
    ...
    Flickable {
        ...
        TextArea {
            ...
            <p>Updates to the base of this distribution included ICU 71.1, Boost 1.79.0, kernel moved to Linux 5.1.7, Systemd 251.4,  KMod 30, Mesa 22.1.7, Texlive packages moved to 2022, Libnl 3.7.0, Libssh 0.10.4, and Upower 1.90.0.</p>

            <p>For the Plasma desktop, the latest Plasma (5.25.5), KDE Gear (22.08.1) and Frameworks (5.78.0) are included. All built on <b>Qt 5.15.5+</b>.</p>
