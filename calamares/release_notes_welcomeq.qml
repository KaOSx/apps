...
Rectangle {
    ...
    Flickable {
        ...
        TextArea {
            ...
            <p>You will find <b>KDE Applications 20.04.0</b> on this ISO already. Highlights of 20.04 include Okular now implements smooth scrolling both when you are using the mouse wheel and the keyboard, Elisa added visual shuffle mode, it’s much easier to rearrange your music in the playlists. Now you can start watching movies stored on remote sites without having to download them, and instead stream them directly from the cloud to your player through <strong>Dolphin</strong>, which also added the new Duplicate fuction. One of KDE Connects newest features shipped with this release is the ability to start new conversations with the SMS app.<br />
            ...
            <p>The ISO ships with <b>Frameworks 5.69.0, Plasma 5.18.4, KDE Applications 20.04.0</b>, Linux 5.5.7, Systemd 244, Kmod 27, NetworkManager 1.22.10, LibreOffice 6.4.3, Krita 4.2.9, Elisa, Xorg-Server 1.20.8, Mesa 20.0.5, Glibc 2.31, GCC 9.3.0, non-free Nvidia 440.82, Pepperflash and Python3 3.7.7 to name a few.</p>
