...
Rectangle {
    ...
    Flickable {
        ...
        TextArea {
            ...
            A limited number of the most well-known GTK applications are available, examples Firefox 80.01, Chrome 86, Ardour 6.2.0, Inkscape 1.0, GIMP 2.10.20 and Google-talkplugin 5.41.3.0.1.<br />
