...
Rectangle {
    ...
    Flickable {
        ...
        TextArea {
            ...
            A limited number of the most well-known GTK applications are available, examples Firefox 80.0.1, Chrome 87, Ardour 6.3.0, Inkscape 1.0.1, GIMP 2.10.20 and Thunderbird 78.2.2.<br />
