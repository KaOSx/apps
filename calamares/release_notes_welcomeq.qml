...
Item {
    ...
    Flickable {
        ...
        TextArea {
            ...
            <p>The ISO ships with <b>Frameworks 5.107.0, Plasma 5.27.6, KDE Applications 23.04.2</b>, Linux 6.3.11, Systemd 253.5, Kmod 30, NetworkManager 1.42.8, LibreOffice 7.5.4, Elisa, Xorg-Server 1.21.8, Mesa 23.1.3, Glibc 2.37, GCC 12.3.0, non-free Nvidia 530 and Python3 3.10.12 to name a few.</p>
