...
Item {
    ...
    TextArea {
        ...
        <p>The ISO ships with <b>Frameworks 5.246.0, Plasma 5.90.0, KDE Applications 24.01.80</b>, Linux 6.5.11, Systemd 254.7, Kmod 31, NetworkManager 1.44.2, LibreOffice 7.6.4, Elisa, Xorg-Server 1.21.10, Mesa 23.3.1, Glibc 2.37, GCC 12.3.0, non-free Nvidia 545 and Python3 3.10.13 to name a few.</p>
        ...
        A limited number of the most well-known GTK applications are available, examples Firefox 120, Chrome 122, Ardour 8.2.0, Inkscape 1.3, GIMP 2.99.16 and Thunderbird 115.<br />
