...
Item {
    ...
    Flickable {
        ...
        TextArea {
            ...
            <p>The ISO ships with <b>Frameworks 5.240.0, Plasma 5.27.80, KDE Applications 23.08.1</b>, Linux 6.4.16, Systemd 254.5, Kmod 31, NetworkManager 1.44.0, LibreOffice 7.6.1, Elisa, Xorg-Server 1.21.8, Mesa 23.2.1, Glibc 2.37, GCC 12.3.0, non-free Nvidia 535 and Python3 3.10.13 to name a few.</p>
            ...
            A limited number of the most well-known GTK applications are available, examples Firefox 118, Chrome 119, Ardour 7.5.0, Inkscape 1.3, GIMP 2.99.16 and Thunderbird 115.<br />
